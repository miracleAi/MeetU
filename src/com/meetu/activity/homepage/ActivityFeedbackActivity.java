...
public class ActivityFeedbackActivity extends Activity implements
		OnClickListener {
	// 控件相关
	...
	private void initView() {
		...
		copylLayout = (RelativeLayout) super
				.findViewById(R.id.copy_feedback_rl);
		copylLayout.setOnClickListener(this);
		backLayout = (RelativeLayout) super
				.findViewById(R.id.back_feedback_homepager_rl);
		backLayout.setOnClickListener(this);
		quedingLayout = (RelativeLayout) super
				.findViewById(R.id.queding_feedback_homepager_rl);
		...
		photoHead = (ImageView) super
				.findViewById(R.id.photo_head_feedback_img);
	...
	private void saveFeedBack() {
		ObjActivityWrap.activityFeedBack(objActivity, user, content.getText()
