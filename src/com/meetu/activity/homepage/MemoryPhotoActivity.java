...
public class MemoryPhotoActivity extends Activity implements OnPageChangeListener{
...
//	private List<PhotoWall> photolist=new ArrayList<PhotoWall>();
	...
	private void initView() {
		...
		favorNumber=(TextView) super.findViewById(R.id.number_favor_memory_detial);
...
//	}
	...
	public void isFavor(final ObjActivityPhoto photo,final ObjUser user){
		ObjActivityPhotoWrap.queryPhotoPraise(photo, user, new ObjFunBooleanCallback() {
