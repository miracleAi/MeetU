...
public class FollowActivity extends FragmentActivity implements OnPageChangeListener,OnCheckedChangeListener{
	...
	private void loadData() {
		...
		ObjFollowWrap.queryfollow(user, new ObjFunMapCallback() {
			...
			public void callback(Map<String, Object> map, AVException e) {
				// TODO Auto-generated method stub
				if(e != null){
					Toast.makeText(getApplicationContext(), "请求关注列表失败", 1000).show();
					return;
				}
