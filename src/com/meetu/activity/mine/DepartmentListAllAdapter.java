	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Department item=mlist.get(position);
			...
			if(convertView==null){
				...
				convertView=LayoutInflater.from(mContext).inflate(R.layout.item_choose_school, null);				
				holder.schoolName=(TextView) convertView.findViewById(R.id.schoolName_school_selector_item_tv);	
