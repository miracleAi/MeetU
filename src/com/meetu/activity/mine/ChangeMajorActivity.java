...
public class ChangeMajorActivity extends Activity implements OnClickListener,
	...
	private void initView() {
		...
		queding = (TextView) super
				.findViewById(R.id.mine_changemajor_majorwancheng_bt);
		...
		backImageView = (ImageView) super
				.findViewById(R.id.back_changemajor_mine);
		backImageView.setOnClickListener(this);
		backLayout = (RelativeLayout) super
				.findViewById(R.id.back_changemajor_mine_rl);
		quedingLayout = (RelativeLayout) super
				.findViewById(R.id.mine_changemajor_majorwancheng_rl);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int positon,
		...
		Intent intent = new Intent(ChangeMajorActivity.this,
		...
		ChangeMajorActivity.this.setResult(RESULT_OK, intent);
		finish();
