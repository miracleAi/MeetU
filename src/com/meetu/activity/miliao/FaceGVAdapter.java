...
//		int mDrawable=mContext.getResources().getIdentifier(list.get(position), "drawable", mContext.getPackageName());
		hodler.iv.setImageResource(Integer.parseInt(""+list.get(position).getId()));
