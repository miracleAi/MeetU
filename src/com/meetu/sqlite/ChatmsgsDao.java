...
public class ChatmsgsDao {
	...
	public void insert(Chatmsgs chatmsgs) {
		...
		db.execSQL(
				"insert into chatmsgs values(null," + "?,?,?,?,?,"
						+ "?,?,?,?,?," + "?,?,?,?,?," + "?,?,?,?,?," + "?,?)",
				new Object[] { chatmsgs.getUid(), chatmsgs.getMessageId(),
	...
	public void update(Chatmsgs chatmsgs) {
		...
		db.execSQL(
				sql,
				new Object[] { chatmsgs.getMessageId(), chatmsgs.getClientId(),
						chatmsgs.getConversationId(),
						chatmsgs.getChatMsgType(),
						chatmsgs.getChatMsgDirection(),
						chatmsgs.getChatMsgStatus(), chatmsgs.getIsShowTime(),
						chatmsgs.getSendTimeStamp(),
