...
public class FollowAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		...
		if(convertView == null){
			...
			convertView = LayoutInflater.from(context).inflate(R.layout.item_joinusers, null);
			convertView.setTag(holder);
		}else{
			holder = (ViewHolder) convertView.getTag();
		}
		holder.nameTv = (TextView) convertView.findViewById(R.id.userName_item_joinUsers_tv);
		holder.avatorImv = (ImageView) convertView.findViewById(R.id.userPhoto_joinUsers_img);
		holder.sexImv = (ImageView) convertView.findViewById(R.id.sex_joinUsers_img);
		holder.schoolTv = (TextView) convertView.findViewById(R.id.school_item_joinUsers_tv);
		holder.positionTv = (TextView) convertView.findViewById(R.id.position_item_joinUser_tv);
		holder.arrowImv = (ImageView) convertView.findViewById(R.id.item_right_arrow);
				...
				public void callback(ObjUser user, AVException e) {
					...
					if(e == null){
						...
						if(user.getProfileClip() != null){
							bitmapUtils.display(holder.avatorImv, user.getProfileClip().getUrl());
						}
