...
public GridRecycleLitterNoteAdapter(Context context, List<ObjScripBox> list) {
	...
	public void onBindViewHolder(MyViewHolder holder,final int position) {
		...
		//	holder.tvName.setText(item.getName());
			...
			if(item.getSender().getObjectId().equals(user.getObjectId())){
				...
				holder.ivNoReadNumber.setText(""+item.getReceiverUnreadCount());
			}
	...
	class MyViewHolder extends ViewHolder {
		...
		public MyViewHolder(View view) {
			super(view);
			ivImg = (ImageView) view.findViewById(R.id.photo_item_note_litter_img);
...
//			ivDetele=(ImageView) view.findViewById(R.id.delete_item_miliao_info_img);
			ivFavor=(ImageView) view.findViewById(R.id.favor_item_note_info_img);
			tvSchool=(TextView) view.findViewById(R.id.school_item_note_tv);
			sexViewImg=(ImageView) view.findViewById(R.id.sex_view_color_img_item_note);
			ivNoReadNumber=(TextView) view.findViewById(R.id.number_noread_item_note_tv);
			}
