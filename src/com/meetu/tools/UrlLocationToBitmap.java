...
public class UrlLocationToBitmap {
	 ...
	 * 其中w和h你需要转换的大小
	 * 
	 * path转换为bitmap:上面方法即可； imageview获取drawable并转换为 bitmap ：Bitmap bt=
	 * ((BitmapDrawable) mImageview.getDrawable()).getBitmap();
	 * resourceid转换为bitmap：Bitmap bt =
	 * BitmapFactory.decodeResource(getResources(), R.drawable.resourceid);
