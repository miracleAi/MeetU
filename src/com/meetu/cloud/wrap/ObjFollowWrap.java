...
public class ObjFollowWrap {
	 ...
	 * @param callback
	 */
	public static void myFollow(final ArrayList<ObjUser> orderUsers,ObjUser user,final ObjUserCallback callback){
		AVQuery<ObjUser> query = ObjUser.followeeQuery(user.getObjectId(), ObjUser.class);
